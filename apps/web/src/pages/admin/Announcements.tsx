...
import { CalendarDays, Clock3, Eye, Pencil, X } from "lucide-react";
import {
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      >
        <div>
          ...
          />
          {errors.title && (
            <div className="mt-1 text-xs text-error">{errors.title.message}</div>
          )}
        </div>
        <div>
          <label className="mb-1 block text-sm font-medium required-label">
          ...
          />
          {errors.message && (
            <div className="mt-1 text-xs text-error">{errors.message.message}</div>
          )}
        </div>
        <div>
